...
int main(int argc, char *argv[]) {
  ...
  /* Set the URI to play */
 // g_object_set (data.playbin,"uri",gst_filename_to_uri("/sintel_trailer-480p.webm",NULL),NULL);
  g_object_set (data.playbin, "uri", "file:///sintel_trailer-480p.webm", NULL); 
  printf("%s %d\n",__FUNCTION__,__LINE__);
  /* Set the subtitle URI to play and some font description */
  g_object_set (data.playbin, "suburi", "file:///sintel_trailer_gr.srt", NULL);
